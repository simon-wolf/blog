...
Back in August [I said that I needed to get better at slow running]({% post_url 2025-08-17-my-first-bad-run %}). It was a bit of a throw-away comment back then, but I am now actually focusing on slower running to improve my aerobic base so it feels like a good time to write up some thoughts about it.
